...
// ambil data file
$namaFile = $_FILES['vid']['name'];
$namaSementara = $_FILES['vid']['tmp_name'];

// tentukan lokasi file akan dipindahkan
$dirUpload = "assets/vid/tenant/";
...
$sql = "INSERT INTO tenant (`id`, `name`, `desc`, `cluster`, `vid`) VALUES ('$id', '$name', '$desc', '$cluster', '$dirUpload$namaFile')";
